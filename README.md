...
<p align="left">
  <a href="https://codecov.io/gh/FlavScheidt/go-libp2p-pubsub"><img src="https://codecov.io/gh/FlavScheidt/go-libp2p-pubsub/branch/master/graph/badge.svg"></a>
  <a href="https://goreportcard.com/report/github.com/FlavScheidt/go-libp2p-pubsub"><img src="https://goreportcard.com/badge/github.com/FlavScheidt/go-libp2p-pubsub" /></a>
  <a href="https://github.com/RichardLitt/standard-readme"><img src="https://img.shields.io/badge/readme%20style-standard-brightgreen.svg?style=flat-square" /></a>
  <a href="https://godoc.org/github.com/FlavScheidt/go-libp2p-pubsub"><img src="http://img.shields.io/badge/godoc-reference-5272B4.svg?style=flat-square" /></a>
...
- Gossipsub, which is a more advanced router with mesh formation and gossip propagation. See [spec](https://github.com/libp2p/specs/tree/master/pubsub/gossipsub) and  [implementation](https://github.com/FlavScheidt/go-libp2p-pubsub/blob/master/gossipsub.go) for more details.
...
```
go get github.com/FlavScheidt/go-libp2p-pubsub
```
...
See the [libp2p specs](https://github.com/libp2p/specs/tree/master/pubsub) for high level documentation and [godoc](https://godoc.org/github.com/FlavScheidt/go-libp2p-pubsub) for API documentation.
...
If you want to trace using a remote peer, you can do so using the `traced` daemon from [go-libp2p-pubsub-tracer](https://github.com/FlavScheidt/go-libp2p-pubsub-tracer). The package also includes a utility program, `tracestat`, for analyzing the traces collected by the daemon.
...
Contributions welcome. Please check out [the issues](https://github.com/FlavScheidt/go-libp2p-pubsub/issues).
